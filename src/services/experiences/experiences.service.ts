...
export const getExperiences = (): Promise<IExperience[]> =>
  new Promise<IExperience[]>((success) => {
    success([
      {
        id: '12',
        firm: 'ABB / Hitachi',
        ...
        start: 'November 2020',
        content: [
          'Working on a monitoring app',
          'Main purpose of application is to allow you to monitor electrical substations and configure various number of parameters',
          'Dealing with lots of live data'
        ],
        skills: [
          ESkill.typescript,
          ESkill.react,
      ...
      },
      {
        ...
        start: 'May 2020',
        content: [
          'Working on a trading app',
          'Super complex and large application which allow you (internal traders) to make and track orders',
          'External UI/UX team, run in SCRUM'
        ],
        skills: [
          ESkill.typescript,
          ESkill.react,
      ...
      },
      {
        ...
        skills: [ESkill.javascript, ESkill.vue, ESkill.php, ESkill.css, ESkill.sass, ESkill.git]
      },
      {
        id: '5',
        firm: 'SwissCom [CGI]',
      ...
      },
      {
        ...
        skills: [ESkill.javascript, ESkill.backbone, ESkill.css, ESkill.sass, ESkill.git]
      },
      {
        id: '7',
      ...
      {
        id: '10',
        firm: 'Freelance / Private projects',
        location: '',
        position: EWorkPosition.junior,
        start: 'January 2000',
        content: ['I spending my free time at constantly polishing my skills'],
        skills: [
          ESkill.typescript,
          ESkill.javascript,
          ESkill.php,
