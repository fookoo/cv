...
const linkedin = 'https://www.linkedin.com/in/piotr-pliszczy%C5%84ski-70041058/'
...
const App: React.FC = () => {
  ...
  useEffect(() => {
    Promise.all([getExperiences(), getSkills()]).then(([experiences, skillsResponse]) => {
  ...
  return (
    <div className="App">
      ...
      <Awards>
        ...
        <p>
          <strong>Kilobity na czarity</strong> - Game made for{' '}
          <strong>Wielka Orkiestra Świątecznej Pomocy</strong> and <strong>Play.pl</strong>, based
          on ICY Tower concept.
        </p>
        <p>
          Build with <strong>Plain JavaScript</strong>
        </p>
      </Awards>
      <HireMe linkedinProfile={linkedin} githubProfile={github} />
    </div>
  )
}
